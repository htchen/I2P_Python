# Week 7 Lab: Building the Smart City Navigator
...
### Required Files
- `week07_starter.py` - Contains starter code with TODO placeholders
...
```bash
# Run all tests
python week07_starter.py --test

# Run in interactive mode
python week07_starter.py

# Run with command-line arguments
python week07_starter.py -s "Taipei 101" -e "Taipei Main Station"
```
...
```bash
# Direct navigation
python week07_starter.py -s "Taipei 101" -e "Taipei Main Station" -p driving

# Multi-stop
python week07_starter.py --multi "Stop A" "Stop B" "Stop C"

# Interactive mode
python week07_starter.py -i
```
...
- [ ] Code passes syntax check (`python -m py_compile week07_starter.py`)
- [ ] Tests pass (`python week07_starter.py --test`)
