#!/usr/bin/env python3
"""
Week 8: Smart City Navigator - Complete Examples

This module contains all the code examples from Week 8 lecture,
...
def example_4_geocoding_service():
    ...
    geocoder = GeocodingService(user_agent="Week8Example/1.0")
...
def run_all_examples():
    ...
    print("\n" + "=" * 60)
    print("  WEEK 8: SMART CITY NAVIGATOR EXAMPLES")
    print("=" * 60)
    print("\nAvailable examples:")
