#!/usr/bin/env python3
"""
Week 8 Lab: Smart City Navigator - Starter Code

Complete the TODO sections to build a fully functional navigation system
that combines geocoding and routing services.

Usage:
    python week08_starter.py --test       # Run tests
    python week08_starter.py -i           # Interactive mode
    python week08_starter.py -s "Start" -e "End"  # Direct navigation
"""
